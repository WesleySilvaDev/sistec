...
class Os extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = [
                ...
                'descricaoModelo' => set_value('descricaoModelo'),
                'descricaoIMEI1' => set_value('descricaoIMEI1'),
                'descricaoIMEI2' => set_value('descricaoIMEI2'),
                'descricaoSN' => set_value('descricaoSN'),
                'descricaoCor' => set_value('descricaoCor'),
    ...
    public function visualizar()
    {
        ...
        $this->data['emitente'] = $this->mapos_model->get('emitente', '*', 'idLoja = '. $idLoja, $this->uri->segment(3));
        $this->data['anexos'] = $this->os_model->getAnexos($this->uri->segment(3));
        $this->data['anotacoes'] = $this->os_model->getAnotacoes($this->uri->segment(3));
