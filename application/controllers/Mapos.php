...
class Mapos extends MY_Controller
{
    ...
    public function emitente()
    {
        ...
        $idLoja = $this->session->userdata('idLoja');
        $this->data['dadosEmitente'] = $this->mapos_model->get('emitente', '*', 'idLoja = '. $idLoja,$this->data['configuration']['per_page'], $this->uri->segment(3));
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->mapos_model->addEmitente($idLoja, $nome, $cnpj, $ie, $cep, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email, $logo);
            if ($retorno) {
    ...
    public function editarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->mapos_model->editEmitente($idLoja,$id, $nome, $cnpj, $ie, $cep, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email);
            if ($retorno) {
