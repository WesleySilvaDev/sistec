...
<div class="widget-box">
   <div class="widget-content padding">
      <table class="table table-bordered table-striped">
         <thead>
            <tr>
               <th style = "width: 35%"><h5>VENDA INICIADA |  N° <?php echo $result->idVendas ?></h5></th>
               <th style = "width: 65%"><h5>LISTA DE PRODUTOS</h5></th>
            </tr>
         </thead>
         <tbody>
            <tr class="odd gradeX">
      ...
      <div class="widget-content nopadding">
         <table class="table table-bordered table-striped">
            <tbody>
                     ...
                     <div class="span12" id="divEditarVenda">
                        <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                           ...
                           <div class="span4"> 
                              ...
                              <input id="observacoes" class="span12" type="text" name="observacoes" value="<?php echo $result->observacoes ?>" />
                           </div>
                     </div>
                  </td>
               </tr>
               ...
               <a href="#modal-faturar" id="btn-faturar" role="button" data-toggle="modal" class="btn btn-success btn-large"><i class="fas fa-cash-register"></i> FATURAR</a>
               <?php
                  } ?>
               <button class="btn btn-primary btn-large" id="btnContinuar"><i class="fas fa-check"></i> SALVAR</button>
               <a href="<?php echo base_url() ?>index.php/vendas/visualizar/<?php echo $result->idVendas; ?>" class="btn btn-warning btn-large"><i class="fas fa-eye"></i>VISUALIZAR RECIBO</a>
               <a href="<?php echo base_url() ?>index.php/vendas" class="btn btn-inverse btn-large"><i class="fas fa-backward"></i> VOLTAR</a>
               </div>
               </div>
               </form>
               </td>
