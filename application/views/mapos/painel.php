...
<div class="row-fluid" style="margin-top: 0; display: flex;">
    <div class="Sspan12">
        <div class="widget-box2">
            <div>
                <h5 class="cardHeader">Agenda: ordens de serviço</h5>
            </div>
            ...
            <div class="widget-box-new" style="height:100%">
                ...
                <div class="new-bottons">
                    <a href="<?php echo base_url(); ?>index.php/clientes/adicionar" class="card" title="Adicionar Clientes e Fornecedores" class="tooltip fade bottom in">
                        ...
                        <div>
                            <div class="cardName2"><?php $this->db->from('clientes'); $this->db->where('idLoja',$this->session->userdata('idLoja')); echo $this->db->count_all_results();?></div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="card" title="Adicionar Produtos" class="tip-bottom">
                        ...
                        <div>
                            <div class="cardName2"><?php $this->db->from('produtos'); $this->db->where('idLoja',$this->session->userdata('idLoja')); echo $this->db->count_all_results();?></div>
                    ...
                    <a href="<?php echo base_url() ?>index.php/servicos/adicionar" class="card">
                        ...
                        <div>
                            <div class="cardName2"><?php $this->db->from('servicos'); $this->db->where('idLoja',$this->session->userdata('idLoja')); echo $this->db->count_all_results();?></div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="card" title="Adicionar Ordens de Serviço" class="tip-bottom">
                        ...
                        <div>
                            <div class="cardName2"><?php $this->db->from('os'); $this->db->where('idLojaOs',$this->session->userdata('idLoja')); echo $this->db->count_all_results();?></div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/garantias" class="card">
                        ...
                        <div>
                            <div class="cardName2"><?php $this->db->from('garantias'); $this->db->where('idLoja',$this->session->userdata('idLoja')); echo $this->db->count_all_results();?></div>
                    ...
                    <a href="<?php echo base_url() ?>index.php/vendas/adicionar" class="card" title="Adicionar Vendas" class="tip-bottom">
                        ...
                        <div>
                            <div class="cardName2"><?php $this->db->from('vendas'); $this->db->where('idLoja',$this->session->userdata('idLoja')); echo $this->db->count_all_results();?></div>
