...
<h2 class="h-two">Sistema de gestão PDV e controle de ordem de serviço</h2>
    <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="Sistec - Versão: <?= $this->config->item('app_version'); ?>">
</div>
<div id="loginbox">
        ...
        <div class="container">
          <div class="card">
            <div class="content">
              ...
              <div id="mcell">Faça login com suas credenciais</div>
              ...
              <div class="links-uteis"><a href=""><p><?= date('Y'); ?> &copy; EVOLUTEC - SISTEC</p></a>
              </div>
              <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
              <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                  <h4 id="myModalLabel">SISTEC</h4>
                </div>
