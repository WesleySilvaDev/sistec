...
<div class="row-fluid" style="margin-top:0">
    <div class="span12">
            ...
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons" style="margin-top:25px;">
                    ...
                    <a target="_blank" title="Imprimir OS Cupom Não Fiscal" class="button btn btn-mini btn-inverse" href="<?php echo site_url() ?>/os/imprimirTermica/<?php echo $result->idOs; ?>">
                      <span class="button__icon"><i class="bx bx-printer"></i></span> <span class="button__text">NÃO FISCAL</span></a>
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                        $this->load->model('os_model');
                        $zapnumber = preg_replace("/[^0-9]/", "", $result->celular_cliente);
                        $troca = [$result->nomeCliente, $result->idOs, $result->status, 'R$ ' . number_format($totalProdutos + $totalServico, 2, ',', '.'), strip_tags($result->descricaoProduto), ($emitente ? $emitente->nome : ''), ($emitente ? $emitente->telefone : ''), strip_tags($result->observacoes), strip_tags($result->defeito), strip_tags($result->laudoTecnico), date('d/m/Y', strtotime($result->dataFinal)), date('d/m/Y', strtotime($result->dataInicial)), $result->garantia . ' dias'];
      ...
      <thead>
         <tr>
            <th style="width: 50%">
               <h5>ORDEM DE SERVIÇO N° <?php echo $result->idOs; ?> </h5>
            </th>
            <th style="width: 50%">
            ...
            <td>
                ...
                <div class="span12" style="padding: 0%; margin-left: 0">
                                        <div class="span12">
                                            ...
                                            <input id="cliente" class="span12" type="text" name="cliente" value="<?php echo $result->nomeCliente ?>" / placeholder="Informe o nome do cliente">
                                        ...
                                        <div class="span8" style="padding: 0%; margin-left: 0">
                                            ...
                                            <input id="tecnico" class="span12" type="text" name="tecnico" value="<?php echo $result->nome ?>" disabled />
                ...
                <div class="span12" style="padding: 0%; margin-left: 0">
                                    ...
                                    <div class="span12 offset2" style="padding: 0%; margin-left: 0 ">  
                                     ...
                                     <center>  
                                            ...
                                            <button class="btn btn-primary" id="btnContinuar"><i class="fas fa-check"></i> SALVAR ALTERAÇÕES</button>
            ...
            <td>
               <div class="span12" style="padding: 0%; margin-left: 0">
                <div class="span6">
                                        ...
                                        <input id="descricaoProduto" class="span12" type="text" name="descricaoProduto" value="<?php echo $result->descricaoProduto ?>" / placeholder="Especifique o aparelho">  
                </div>
                <div class="span6" >
                                        <label for="cliente">Modelo<span class="required"></span></label>
                                        <input id="descricaoModelo" class="span12" type="text" name="descricaoModelo" value="<?php echo $result->descricaoModelo ?>" / placeholder="Modelo"> 
                </div>
                <div class="span12" style="padding: 0%; margin-left: 0">
                <div class="span6" style="padding: 0%;">
                                        <label for="cliente">IMEI<span class="required"></span></label>
                                        <input id="descricaoIMEI1" class="span12" type="text" name="descricaoIMEI1" value="<?php echo $result->descricaoIMEI1 ?>" / placeholder="35xxxxxxxxxxxxx">
                </div>
                <div class="span6" style="padding: 0%;">
                                        <label for="cliente">IMEI<span class="required"></span></label>
                                        <input id="descricaoIMEI2" class="span12" type="text" name="descricaoIMEI2" value="<?php echo $result->descricaoIMEI2 ?>" / placeholder="35xxxxxxxxxxxxx">  
                </div>
                </div>
                <div class="span12" style="padding: 0%; margin-left: 0">
                <div class="span6" style="padding: 0%;">
                                        <label for="cliente">N° de série ( SN )<span class="required"></span></label>
                                        <input id="descricaoSN" class="span12" type="text" name="descricaoSN" value="<?php echo $result->descricaoSN ?>" / placeholder="Verso do aparelho">  
                </div>
                <div class="span6" style="padding: 0%;">
                                        <label for="cliente">COR<span class="required"></span></label>
                                        <input id="descricaoCor" class="span12" type="text" name="descricaoCor" value="<?php echo $result->descricaoCor ?>" / placeholder="Cor principal">  
                </div> 
                </div>
                                    ...
                                    <div class="span6" style="padding: 0%; margin-left: 0">
                                        ...
                                        <textarea class="span12" name="defeito" id="defeito" cols="10" rows="1"><?php echo $result->defeito ?></textarea>
                                    </div>
                                    <div class="span6" style="padding: 0%;">
                                        <label for="observacoes">
                                            <h5>Observações</h5>
                                        </label>
                                        <textarea  class="span12" name="observacoes" id="observacoes" cols="10" rows="1"><?php echo $result->observacoes ?></textarea>
                                    </div>
                                    <div class="span12" style="padding: 0%; margin-left: 0">
                                        <label for="laudoTecnico">
                                            <h5>Laudo Técnico</h5>
                                        </label>
                                        <textarea class="span12" name="laudoTecnico" id="laudoTecnico" cols="10" rows="1"><?php echo $result->laudoTecnico ?></textarea>
                                    </div>
                                     </form>
