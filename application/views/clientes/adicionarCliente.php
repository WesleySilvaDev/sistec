                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="senha" type="text" name="senha" value="<?php echo set_value('senha'); ?>"/>
                ...
                <div class="form-actions">
                    <div class="span12">
                        <div class="span6 offset3" style="display:flex;justify-content: center">
                            <button type="submit" class="button btn btn-mini btn-success" style=""><span class="button__icon"><i class='bx bx-save'></i></span> <span class="button__text2">Salvar</span></a></button>
